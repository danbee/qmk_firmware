...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QW] = LAYOUT( /* Qwerty */
    ...
    CTL_TAB, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, QUOT_L2,
  ...
  /*┌───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬───┬──────┐
    ...
    └────┴─────┴────┴────────┴───────┴────┴─────┴──────┘*/
  [_L2] = LAYOUT( /* LAYER 2 */
    KC_NUBS, KC_BRMD, KC_BRMU, _______, RESET,   _______, _______, _______, _______, KC_MINS, KC_EQL,  KC_EJCT,
